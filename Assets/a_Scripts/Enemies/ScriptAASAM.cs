...
public class ScriptAASAM : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        bulletXY[0] = new Vector3(-1.4f, 2.25f, 0);
        bulletXY[1] = new Vector3(0, 2.25f, 0);
        bulletXY[2] = new Vector3(1.4f, 2.25f, 0);
        bulletXY[3] = new Vector3(-1.4f, 0.75f, 0);
        bulletXY[4] = new Vector3(0, 0.75f, 0);
        bulletXY[5] = new Vector3(1.4f, 0.75f, 0);
    ...
    void Start()
    {
        ...
        turret.eulerAngles = new Vector3((int)Random.Range(-5f, -20f), turret.eulerAngles.y, turret.eulerAngles.z);
