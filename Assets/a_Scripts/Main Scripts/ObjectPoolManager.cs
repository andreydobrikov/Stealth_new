...
public class ObjectPoolManager : MonoBehaviour
{
	...
	public Rect debugGuiRect = new Rect( 10, 40, 60, 400 );
	...
	public static GameObject CreatePooled( GameObject prefab, Vector3 position, Quaternion rotation,int tempID )
	{
		return Instance.InternalCreate (prefab, position, rotation, tempID);
	...
	private GameObject InternalCreate(GameObject prefab, Vector3 position, Quaternion rotation, int tempID)
	{
		ObjectPool pool;
		...
		GameObject obj = pool.Instanciate (position, rotation, tempID);
